...
.\meta.ps1 apply .\shared\.editorconfig -RelativePath .editorconfig -Filter "OrgBrand*"
```
...
- `-Filter 'OrgBrand*'` - wildcard on folder name
...
### Coworkers (shared OrgBrand portfolio)
