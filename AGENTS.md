...
- Portfolio facts need a home (routing / ctx / Decision Registry / Decisions.md / OCC / project AGENTS.md / Ops health) - see [docs/Decisions.md](docs/Decisions.md) (Portfolio Operations Principles). Do not invent a parallel home.
