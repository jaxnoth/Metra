...
$script:MetraCompatibilityFunctions = @(
    ...
    'Invoke-MetraInspectReviewLoop',
    'Invoke-MetraInspectPackOnly',
    'Show-MetraUnblockCli',
    'Show-MetraTailscaleCli',
    'Show-MetraSecurityAuditCli',
    'Invoke-MetraSecuritySurfaceAudit',
    'Test-MetraTrackedSelfDocSharedOnly',
    ...
    'Install-MetraOpsDeskTask',
    'Uninstall-MetraOpsDeskTask',
    ...
    'ConvertTo-MetraAskInput',
    'Test-MetraAskConversationExecutionEnabled',
    'Test-MetraAskVisionPhoneClient',
    ...
    'Get-MetraConversationIdentityManifest',
    'Get-MetraConversationIdentitySources',
    'Get-MetraConversationIdentityPrompt',
    'Test-MetraConversationIdentityPackActive',
    'Get-MetraVisionAskSystemPrompt',
    'Get-MetraVisionAskPresentationMood',
    'Invoke-MetraVisionAskHandler',
    'Resolve-MetraAskHttpDispatch',
